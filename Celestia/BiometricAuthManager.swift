...
class BiometricAuthManager: ObservableObject {
    ...
    func authenticate(reason: String = "Authenticate to access CoFoundry") async throws -> Bool {
    ...
    /// - Returns: True if authentication succeeded
    func authenticateWithPasscode(reason: String = "Authenticate to access CoFoundry") async throws -> Bool {
        let context = LAContext()
    ...
    func enableBiometricAuth() async throws -> Bool {
        ...
        let success = try await authenticate(reason: "Enable \(biometricTypeString) for CoFoundry")
...
/*
 ...
 // In App Launch (CoFoundryApp.swift or RootView):
