            ...
            VStack {
                HStack {
                    ...
                    if let userId = user.id,
                       !userId.isEmpty,
                       let shareURL = URL(string: "https://cofoundry.app/profile/\(userId)"),
                       shareURL.scheme == "https" {
                        ShareLink(item: shareURL, subject: Text("Check out \(user.fullName)'s profile"), message: Text("See \(user.fullName) on CoFoundry!")) {
                        ...
                        .accessibilityHint("Share your CoFoundry profile with others")
                    }
    ...
    private var actionButtons: some View {
        VStack(spacing: 12) {
            actionButton(
                ...
                title: "Help & Support",
                color: .blue,
                accessibilityHint: "Contact CoFoundry support team for assistance"
            ) {
                guard let url = URL(string: "mailto:support@cofoundry.app"),
            ...
            actionButton(
                ...
                title: "Sign Out",
                color: .red,
                accessibilityHint: "Sign out of your CoFoundry account"
            ) {
