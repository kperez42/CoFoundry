...
/// Converts Firebase NSError codes to user-friendly CoFoundryError types and messages
enum FirebaseErrorMapper {
    ...
    static func mapError(_ error: NSError) -> CoFoundryError {
        switch error.domain {
    ...
    /// Use this when you don't need the CoFoundryError type
    ...
    /// Map Firebase Authentication errors to CoFoundryError
    private static func mapAuthError(_ error: NSError) -> CoFoundryError {
        switch error.code {
    ...
    /// Map Firebase Storage errors to CoFoundryError
    /// Reference: https://firebase.google.com/docs/storage/ios/handle-errors
    private static func mapStorageError(_ error: NSError) -> CoFoundryError {
        switch error.code {
        // Object/Path errors
    ...
    /// Map Firebase Firestore errors to CoFoundryError
    /// Covers all FirestoreErrorCode cases for comprehensive error handling
    private static func mapFirestoreError(_ error: NSError) -> CoFoundryError {
        switch error.code {
    ...
    /// Get recovery suggestion for CoFoundryError with optional original NSError context
    static func getRecoverySuggestion(for error: CoFoundryError, originalError: NSError? = nil) -> String {
        switch error {
        ...
        case .accountDisabled:
            return "Contact support at help@cofoundry.app for assistance."
        ...
        default:
            return "If the problem persists, contact support at help@cofoundry.app"
        }
    }
...
// MARK: - CoFoundryError Extension

extension CoFoundryError {
