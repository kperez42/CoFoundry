...
struct PremiumUpgradeView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Discover more co-founders who match your vision")
    ...
    private var showcaseCard: some View {
        let showcases = [
            ("23 people are interested in you", "person.2.circle.fill", Color.pink, "See who they are with Premium"),
            ("You're missing 15+ profiles", "eye.slash.fill", Color.purple, "Get unlimited browsing"),
            ("Unlimited interests available", "hand.thumbsup.fill", Color.green, "Express interest in as many profiles as you want"),
            ("Send unlimited messages", "message.circle.fill", Color.blue, "Connect with any co-founder you want")
        ]
    ...
    private var impactStats: some View {
        HStack(spacing: 0) {
            impactStat(value: "3x", label: "More Connections", icon: "person.2.fill", color: .pink)
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 0) {
                    ...
                    comparisonRow(feature: "Daily Interests", free: "10/day", premium: "Unlimited", icon: "hand.thumbsup.fill")
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 12) {
                successStoryCard(
                    initials: "JM",
                    name: "Jake M.",
                    story: "Found my co-founder within 2 weeks! The 'See Who's Interested' feature was a game changer.",
                    color: .purple
                )
                ...
                successStoryCard(
                    initials: "SE",
                    name: "Sarah E.",
                    story: "So many more quality connections since upgrading. Unlimited interests means I never miss a potential co-founder.",
                    color: .pink
                )
                ...
                successStoryCard(
                    initials: "AT",
                    name: "Alex T.",
                    story: "Profile boost got me 3x the views. Met amazing co-founders I would have missed.",
                    color: .orange
                )
            }
        }
